...
Public Class CRRepairments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssetManagement.CRRepairments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRRepairments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRRepairments = New CRRepairments
        rpt.Site = Me.Site
        Return rpt
    End Function
