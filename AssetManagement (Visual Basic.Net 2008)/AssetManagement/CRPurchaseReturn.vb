...
Public Class CRPurchaseReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssetManagement.CRPurchaseReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPurchaseReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPurchaseReturn = New CRPurchaseReturn
        rpt.Site = Me.Site
        Return rpt
    End Function
